...
Public Class FrmMonitor3
    ...
    Private Sub FrmMonitor3_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub FrmMonitor3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Label4.Text = ""
        ...
        Me.Top = myScreens(2).WorkingArea.Top
        Me.Left = myScreens(2).WorkingArea.Left
        Me.Height = screenHeight3
        Me.Width = screenWidth3
        Me.Show()
